...
(defun get-item-pos (line col item)
...
(defun merlin-imenu-create-index ()
  ...
  ;; Read outline tree
  (merlin/sync)
  (parse-outline-tree "" (merlin/send-command `outline))
  (let ((index ()))
