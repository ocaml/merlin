...
# 524 "parsing/lexer.mll"
      ( let name = ident_for_extended lexbuf raw_name in
        ...
        LABEL name )
# 5943 "parsing/lexer.ml"

  | 8 ->
# 528 "parsing/lexer.mll"
      ( QUESTION )
# 5948 "parsing/lexer.ml"

  | 9 ->
let
# 529 "parsing/lexer.mll"
                                  name
# 5954 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf (lexbuf.Lexing.lex_start_pos + 1) (lexbuf.Lexing.lex_curr_pos + -1) in
# 530 "parsing/lexer.mll"
      ( check_label_name lexbuf name;
        OPTLABEL name )
# 5959 "parsing/lexer.ml"

  | 10 ->
let
# 532 "parsing/lexer.mll"
                              escape
# 5965 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf (lexbuf.Lexing.lex_start_pos + 1) lexbuf.Lexing.lex_mem.(0)
and
# 532 "parsing/lexer.mll"
                                                    raw_name
# 5970 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_mem.(0) (lexbuf.Lexing.lex_curr_pos + -1) in
...
# 6134 "parsing/lexer.ml"

  | 23 ->
let
# 582 "parsing/lexer.mll"
                           raw_id
# 6140 "parsing/lexer.ml"
...
# 6148 "parsing/lexer.ml"

  | 24 ->
let
# 588 "parsing/lexer.mll"
                           raw_id
# 6154 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf (lexbuf.Lexing.lex_start_pos + 3) lexbuf.Lexing.lex_mem.(0)
and
# 588 "parsing/lexer.mll"
                                                        raw_delim
# 6159 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_mem.(1) (lexbuf.Lexing.lex_curr_pos + -1) in
...
# 6175 "parsing/lexer.ml"
  ...
  | 26 ->
let
# 599 "parsing/lexer.mll"
                                         c
# 6181 "parsing/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1) in
# 600 "parsing/lexer.mll"
      ( CHAR c )
# 6185 "parsing/lexer.ml"

  | 27 ->
let
# 601 "parsing/lexer.mll"
                                                    c
# 6191 "parsing/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 2) in
# 602 "parsing/lexer.mll"
      ( CHAR (char_for_backslash c) )
# 6195 "parsing/lexer.ml"

  | 28 ->
# 604 "parsing/lexer.mll"
      ( CHAR(char_for_decimal_code lexbuf 2) )
# 6200 "parsing/lexer.ml"

  | 29 ->
# 606 "parsing/lexer.mll"
      ( CHAR(char_for_octal_code lexbuf 3) )
# 6205 "parsing/lexer.ml"

  | 30 ->
# 608 "parsing/lexer.mll"
      ( CHAR(char_for_hexadecimal_code lexbuf 3) )
# 6210 "parsing/lexer.ml"

  | 31 ->
let
# 609 "parsing/lexer.mll"
                          esc
# 6216 "parsing/lexer.ml"
...
# 6241 "parsing/lexer.ml"

  | 35 ->
let
# 623 "parsing/lexer.mll"
                     stars
# 6247 "parsing/lexer.ml"
...
# 6300 "parsing/lexer.ml"

  | 40 ->
# 657 "parsing/lexer.mll"
         ( AMPERSAND )
# 6305 "parsing/lexer.ml"

  | 41 ->
# 658 "parsing/lexer.mll"
         ( AMPERAMPER )
# 6310 "parsing/lexer.ml"

  | 42 ->
# 659 "parsing/lexer.mll"
         ( BACKQUOTE )
# 6315 "parsing/lexer.ml"

  | 43 ->
# 660 "parsing/lexer.mll"
         ( QUOTE )
# 6320 "parsing/lexer.ml"

  | 44 ->
# 661 "parsing/lexer.mll"
         ( LPAREN )
# 6325 "parsing/lexer.ml"

  | 45 ->
# 662 "parsing/lexer.mll"
         ( RPAREN )
# 6330 "parsing/lexer.ml"

  | 46 ->
# 663 "parsing/lexer.mll"
         ( STAR )
# 6335 "parsing/lexer.ml"

  | 47 ->
# 664 "parsing/lexer.mll"
         ( COMMA )
# 6340 "parsing/lexer.ml"

  | 48 ->
# 665 "parsing/lexer.mll"
         ( MINUSGREATER )
# 6345 "parsing/lexer.ml"

  | 49 ->
# 666 "parsing/lexer.mll"
         ( DOT )
# 6350 "parsing/lexer.ml"

  | 50 ->
# 667 "parsing/lexer.mll"
         ( DOTDOT )
# 6355 "parsing/lexer.ml"
...
# 668 "parsing/lexer.mll"
                                          ( DOTOP op )
# 6365 "parsing/lexer.ml"

  | 52 ->
# 669 "parsing/lexer.mll"
         ( COLON )
# 6370 "parsing/lexer.ml"

  | 53 ->
# 670 "parsing/lexer.mll"
         ( COLONCOLON )
# 6375 "parsing/lexer.ml"

  | 54 ->
# 671 "parsing/lexer.mll"
         ( COLONEQUAL )
# 6380 "parsing/lexer.ml"

  | 55 ->
# 672 "parsing/lexer.mll"
         ( COLONGREATER )
# 6385 "parsing/lexer.ml"

  | 56 ->
# 673 "parsing/lexer.mll"
         ( SEMI )
# 6390 "parsing/lexer.ml"

  | 57 ->
# 674 "parsing/lexer.mll"
         ( SEMISEMI )
# 6395 "parsing/lexer.ml"

  | 58 ->
# 675 "parsing/lexer.mll"
         ( LESS )
# 6400 "parsing/lexer.ml"

  | 59 ->
# 676 "parsing/lexer.mll"
         ( LESSMINUS )
# 6405 "parsing/lexer.ml"

  | 60 ->
# 677 "parsing/lexer.mll"
         ( EQUAL )
# 6410 "parsing/lexer.ml"

  | 61 ->
# 678 "parsing/lexer.mll"
         ( LBRACKET )
# 6415 "parsing/lexer.ml"

  | 62 ->
# 679 "parsing/lexer.mll"
         ( LBRACKETBAR )
# 6420 "parsing/lexer.ml"

  | 63 ->
# 680 "parsing/lexer.mll"
         ( LBRACKETLESS )
# 6425 "parsing/lexer.ml"

  | 64 ->
# 681 "parsing/lexer.mll"
         ( LBRACKETGREATER )
# 6430 "parsing/lexer.ml"

  | 65 ->
# 682 "parsing/lexer.mll"
         ( RBRACKET )
# 6435 "parsing/lexer.ml"

  | 66 ->
# 683 "parsing/lexer.mll"
         ( LBRACE )
# 6440 "parsing/lexer.ml"

  | 67 ->
# 684 "parsing/lexer.mll"
         ( LBRACELESS )
# 6445 "parsing/lexer.ml"

  | 68 ->
# 685 "parsing/lexer.mll"
         ( BAR )
# 6450 "parsing/lexer.ml"

  | 69 ->
# 686 "parsing/lexer.mll"
         ( BARBAR )
# 6455 "parsing/lexer.ml"

  | 70 ->
# 687 "parsing/lexer.mll"
         ( BARRBRACKET )
# 6460 "parsing/lexer.ml"

  | 71 ->
# 688 "parsing/lexer.mll"
         ( GREATER )
# 6465 "parsing/lexer.ml"

  | 72 ->
# 689 "parsing/lexer.mll"
         ( GREATERRBRACKET )
# 6470 "parsing/lexer.ml"

  | 73 ->
# 690 "parsing/lexer.mll"
         ( RBRACE )
# 6475 "parsing/lexer.ml"

  | 74 ->
# 691 "parsing/lexer.mll"
         ( GREATERRBRACE )
# 6480 "parsing/lexer.ml"

  | 75 ->
# 692 "parsing/lexer.mll"
         ( LBRACKETAT )
# 6485 "parsing/lexer.ml"

  | 76 ->
# 693 "parsing/lexer.mll"
           ( LBRACKETATAT )
# 6490 "parsing/lexer.ml"

  | 77 ->
# 694 "parsing/lexer.mll"
           ( LBRACKETATATAT )
# 6495 "parsing/lexer.ml"

  | 78 ->
# 695 "parsing/lexer.mll"
           ( LBRACKETPERCENT )
# 6500 "parsing/lexer.ml"

  | 79 ->
# 696 "parsing/lexer.mll"
           ( LBRACKETPERCENTPERCENT )
# 6505 "parsing/lexer.ml"

  | 80 ->
# 697 "parsing/lexer.mll"
         ( BANG )
# 6510 "parsing/lexer.ml"

  | 81 ->
# 698 "parsing/lexer.mll"
         ( INFIXOP0 "!=" )
# 6515 "parsing/lexer.ml"

  | 82 ->
# 699 "parsing/lexer.mll"
         ( PLUS )
# 6520 "parsing/lexer.ml"

  | 83 ->
# 700 "parsing/lexer.mll"
         ( PLUSDOT )
# 6525 "parsing/lexer.ml"

  | 84 ->
# 701 "parsing/lexer.mll"
         ( PLUSEQ )
# 6530 "parsing/lexer.ml"

  | 85 ->
# 702 "parsing/lexer.mll"
         ( MINUS )
# 6535 "parsing/lexer.ml"

  | 86 ->
# 703 "parsing/lexer.mll"
         ( MINUSDOT )
# 6540 "parsing/lexer.ml"
...
# 706 "parsing/lexer.mll"
            ( PREFIXOP op )
# 6550 "parsing/lexer.ml"

  | 88 ->
let
# 707 "parsing/lexer.mll"
                                      op
# 6556 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 708 "parsing/lexer.mll"
            ( PREFIXOP op )
# 6560 "parsing/lexer.ml"

  | 89 ->
let
# 709 "parsing/lexer.mll"
                                              op
# 6566 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 710 "parsing/lexer.mll"
            ( INFIXOP0 op )
# 6570 "parsing/lexer.ml"

  | 90 ->
let
# 711 "parsing/lexer.mll"
                              op
# 6576 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 712 "parsing/lexer.mll"
            ( INFIXOP1 op )
# 6580 "parsing/lexer.ml"

  | 91 ->
let
# 713 "parsing/lexer.mll"
                              op
# 6586 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 714 "parsing/lexer.mll"
            ( INFIXOP2 op )
# 6590 "parsing/lexer.ml"

  | 92 ->
let
# 715 "parsing/lexer.mll"
                         op
# 6596 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 716 "parsing/lexer.mll"
            ( INFIXOP4 op )
# 6600 "parsing/lexer.ml"

  | 93 ->
# 717 "parsing/lexer.mll"
            ( PERCENT )
# 6605 "parsing/lexer.ml"
...
# 719 "parsing/lexer.mll"
            ( INFIXOP3 op )
# 6615 "parsing/lexer.ml"

  | 95 ->
let
# 720 "parsing/lexer.mll"
                                op
# 6621 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 721 "parsing/lexer.mll"
            ( HASHOP op )
# 6625 "parsing/lexer.ml"

  | 96 ->
let
# 722 "parsing/lexer.mll"
                                       op
# 6631 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 723 "parsing/lexer.mll"
            ( LETOP op )
# 6635 "parsing/lexer.ml"

  | 97 ->
let
# 724 "parsing/lexer.mll"
                                       op
# 6641 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 725 "parsing/lexer.mll"
            ( ANDOP op )
# 6645 "parsing/lexer.ml"

  | 98 ->
# 726 "parsing/lexer.mll"
        ( EOF )
# 6650 "parsing/lexer.ml"
...
and __ocaml_lex_comment_rec lexbuf __ocaml_lex_state =
  match Lexing.new_engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 749 "parsing/lexer.mll"
      ( comment_start_loc := (Location.curr lexbuf) :: !comment_start_loc;
        store_lexeme lexbuf;
        comment lexbuf
      )
# 6716 "parsing/lexer.ml"

  | 1 ->
# 754 "parsing/lexer.mll"
...
# 762 "parsing/lexer.mll"
      (
        ...
        store_string_char '\"';
        comment lexbuf )
# 6747 "parsing/lexer.ml"

  | 3 ->
let
# 778 "parsing/lexer.mll"
                                                      raw_delim
# 6753 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_mem.(0) (lexbuf.Lexing.lex_curr_pos + -1) in
# 779 "parsing/lexer.mll"
      ( match lax_delim raw_delim with
        ...
        store_string_char '}';
        comment lexbuf )
# 6776 "parsing/lexer.ml"

  | 4 ->
# 800 "parsing/lexer.mll"
      ( store_lexeme lexbuf; comment lexbuf )
# 6781 "parsing/lexer.ml"

  | 5 ->
let
# 801 "parsing/lexer.mll"
                     nl
# 6787 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf (lexbuf.Lexing.lex_start_pos + 1) (lexbuf.Lexing.lex_curr_pos + -1) in
...
# 6796 "parsing/lexer.ml"

  | 6 ->
# 809 "parsing/lexer.mll"
      ( store_lexeme lexbuf; comment lexbuf )
# 6801 "parsing/lexer.ml"

  | 7 ->
# 811 "parsing/lexer.mll"
      ( store_lexeme lexbuf; comment lexbuf )
# 6806 "parsing/lexer.ml"

  | 8 ->
# 813 "parsing/lexer.mll"
      ( store_lexeme lexbuf; comment lexbuf )
# 6811 "parsing/lexer.ml"

  | 9 ->
# 815 "parsing/lexer.mll"
      ( store_lexeme lexbuf; comment lexbuf )
# 6816 "parsing/lexer.ml"

  | 10 ->
# 817 "parsing/lexer.mll"
      ( store_lexeme lexbuf; comment lexbuf )
# 6821 "parsing/lexer.ml"
...
# 6845 "parsing/lexer.ml"

  | 13 ->
# 832 "parsing/lexer.mll"
      ( store_lexeme lexbuf; comment lexbuf )
# 6850 "parsing/lexer.ml"

  | 14 ->
# 834 "parsing/lexer.mll"
      ( store_lexeme lexbuf; comment lexbuf )
# 6855 "parsing/lexer.ml"
...
# 838 "parsing/lexer.mll"
      ( lexbuf.lex_start_p )
# 6867 "parsing/lexer.ml"

  | 1 ->
let
# 839 "parsing/lexer.mll"
                     nl
# 6873 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf (lexbuf.Lexing.lex_start_pos + 1) lexbuf.Lexing.lex_mem.(0)
and
# 839 "parsing/lexer.mll"
                                          space
# 6878 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_mem.(0) lexbuf.Lexing.lex_curr_pos in
...
# 6938 "parsing/lexer.ml"

  | 8 ->
let
# 874 "parsing/lexer.mll"
               nl
# 6944 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
...
# 6988 "parsing/lexer.ml"

  | 1 ->
# 893 "parsing/lexer.mll"
      ( is_in_string := false;
        error_loc !string_start_loc Unterminated_string )
# 6994 "parsing/lexer.ml"

  | 2 ->
let
# 895 "parsing/lexer.mll"
                       raw_edelim
# 7000 "parsing/lexer.ml"
= Lexing.sub_lexeme lexbuf (lexbuf.Lexing.lex_start_pos + 1) (lexbuf.Lexing.lex_curr_pos + -1) in
...
# 7008 "parsing/lexer.ml"

  | 3 ->
let
# 901 "parsing/lexer.mll"
          c
# 7014 "parsing/lexer.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 902 "parsing/lexer.mll"
      ( store_string_char c;
        quoted_string delim lexbuf )
# 7019 "parsing/lexer.ml"
...
# 7031 "parsing/lexer.ml"

  | 1 ->
# 909 "parsing/lexer.mll"
      ( update_loc lexbuf None 1 false 0 )
# 7036 "parsing/lexer.ml"

  | 2 ->
# 910 "parsing/lexer.mll"
       ( () )
# 7041 "parsing/lexer.ml"
