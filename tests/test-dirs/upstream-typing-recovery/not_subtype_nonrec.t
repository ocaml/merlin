Upstream runs this WITHOUT -typing-recovery (single error). Merlin has
recovery on unconditionally, so it emits multiple diagnostics here.

  $ cat >not_subtype_nonrec.ml <<'EOF'
  ...
  $ $MERLIN single errors -filename not_subtype_nonrec.ml < not_subtype_nonrec.ml
  {
    "class": "return",
    "value": [
      {
