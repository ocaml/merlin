...
val alerts_of_attrs: Parsetree.attributes -> string Misc.StringMap.t
val alerts_of_sig: Parsetree.signature -> string Misc.StringMap.t
val alerts_of_str: Parsetree.structure -> string Misc.StringMap.t
