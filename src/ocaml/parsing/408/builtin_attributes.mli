...
val alerts_of_attrs: Parsetree.attributes -> string Misc.String.Map.t
val alerts_of_sig: Parsetree.signature -> string Misc.String.Map.t
val alerts_of_str: Parsetree.structure -> string Misc.String.Map.t
