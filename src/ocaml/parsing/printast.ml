...
let fmt_char_option f =
  function None -> fprintf f "None" | Some c -> fprintf f "Some %c" c
...
let rec core_type i ppf x =
  ...
  | Ptyp_constr (li, l) ->
    line i ppf "Ptyp_constr %a\n" fmt_longident_loc li; list i core_type ppf l
  ...
  | Ptyp_object (l, c) ->
    ...
    List.iter (fun field ->
      ...
      | Otag (l, t) ->
        line i ppf "method %s\n" l.txt;
        attributes i ppf field.pof_attributes; core_type (i + 1) ppf t
      | Oinherit ct -> line i ppf "Oinherit\n"; core_type (i + 1) ppf ct
    ) l
  | Ptyp_class (li, l) ->
    line i ppf "Ptyp_class %a\n" fmt_longident_loc li; list i core_type ppf l
  | Ptyp_alias (ct, s) -> line i ppf "Ptyp_alias \"%s\"\n" s; core_type i ppf ct
  | Ptyp_poly (sl, ct) ->
  ...
  | Ptyp_extension (s, arg) ->
    line i ppf "Ptyp_extension \"%s\"\n" s.txt; payload i ppf arg

and package_with i ppf (s, t) =
  line i ppf "with type %a\n" fmt_longident_loc s; core_type i ppf t
...
and pattern i ppf x =
  ...
  | Ppat_alias (p, s) ->
    line i ppf "Ppat_alias %a\n" fmt_string_loc s; pattern i ppf p
...
and expression i ppf x =
  ...
  | Pexp_function l -> line i ppf "Pexp_function\n"; list i case ppf l
  | Pexp_fun (l, eo, p, e) ->
    line i ppf "Pexp_fun\n";
    arg_label i ppf l;
    option i expression ppf eo; pattern i ppf p; expression i ppf e
  | Pexp_apply (e, l) ->
  ...
  | Pexp_record (l, eo) ->
    ...
    list i longident_x_expression ppf l; option i expression ppf eo
  | Pexp_field (e, li) ->
    line i ppf "Pexp_field\n"; expression i ppf e; longident_loc i ppf li
  | Pexp_setfield (e1, li, e2) ->
    line i ppf "Pexp_setfield\n";
    expression i ppf e1; longident_loc i ppf li; expression i ppf e2
  ...
  | Pexp_constraint (e, ct) ->
    line i ppf "Pexp_constraint\n"; expression i ppf e; core_type i ppf ct
  | Pexp_coerce (e, cto1, cto2) ->
    line i ppf "Pexp_coerce\n";
    expression i ppf e; option i core_type ppf cto1; core_type i ppf cto2
  | Pexp_send (e, s) ->
    line i ppf "Pexp_send \"%s\"\n" s.txt; expression i ppf e
  | Pexp_new li -> line i ppf "Pexp_new %a\n" fmt_longident_loc li
  | Pexp_setinstvar (s, e) ->
    line i ppf "Pexp_setinstvar %a\n" fmt_string_loc s; expression i ppf e
  | Pexp_override l ->
  ...
  | Pexp_open (o, e) ->
    ...
    module_expr i ppf o.popen_expr; expression i ppf e
  | Pexp_letop { let_; ands; body } ->
    line i ppf "Pexp_letop\n";
    binding_op i ppf let_; list i binding_op ppf ands; expression i ppf body
...
and value_description i ppf x =
  ...
  core_type (i + 1) ppf x.pval_type; list (i + 1) string ppf x.pval_prim
...
and attribute i ppf k a =
  line i ppf "%s \"%s\"\n" k a.attr_name.txt; payload i ppf a.attr_payload
...
and payload i ppf =
  ...
  | PPat (x, Some g) ->
    pattern i ppf x; line i ppf "<when>\n"; expression (i + 1) ppf g
...
and type_kind i ppf x =
  ...
  | Ptype_record l -> line i ppf "Ptype_record\n"; list (i + 1) label_decl ppf l
...
and class_type i ppf x =
  ...
  | Pcty_signature cs -> line i ppf "Pcty_signature\n"; class_signature i ppf cs
  | Pcty_arrow (l, co, cl) ->
...
and class_expr i ppf x =
  ...
  | Pcl_structure cs -> line i ppf "Pcl_structure\n"; class_structure i ppf cs
  | Pcl_fun (l, eo, p, e) ->
    line i ppf "Pcl_fun\n";
    arg_label i ppf l;
    option i expression ppf eo; pattern i ppf p; class_expr i ppf e
  | Pcl_apply (ce, l) ->
    line i ppf "Pcl_apply\n";
    class_expr i ppf ce; list i label_x_expression ppf l
  | Pcl_let (rf, l, ce) ->
    line i ppf "Pcl_let %a\n" fmt_rec_flag rf;
    list i value_binding ppf l; class_expr i ppf ce
...
and class_field i ppf x =
  ...
  | Pcf_inherit (ovf, ce, so) ->
    ...
    class_expr (i + 1) ppf ce; option (i + 1) string_loc ppf so
  | Pcf_val (s, mf, k) ->
    line i ppf "Pcf_val %a\n" fmt_mutable_flag mf;
    line (i + 1) ppf "%a\n" fmt_string_loc s; class_field_kind (i + 1) ppf k
  | Pcf_method (s, pf, k) ->
...
and module_type i ppf x =
  ...
  | Pmty_signature s -> line i ppf "Pmty_signature\n"; signature i ppf s
  ...
  | Pmty_with (mt, l) ->
    line i ppf "Pmty_with\n"; module_type i ppf mt; list i with_constraint ppf l
...
and signature_item i ppf x =
  ...
  | Psig_exception te -> line i ppf "Psig_exception\n"; type_exception i ppf te
  | Psig_module pmd ->
    line i ppf "Psig_module %a\n" fmt_str_opt_loc pmd.pmd_name;
    attributes i ppf pmd.pmd_attributes; module_type i ppf pmd.pmd_type
  | Psig_modsubst pms ->
  ...
  | Psig_modtype x ->
    ...
    attributes i ppf x.pmtd_attributes; modtype_declaration i ppf x.pmtd_type
  | Psig_open od ->
  ...
  | Psig_include incl ->
    ...
    module_type i ppf incl.pincl_mod; attributes i ppf incl.pincl_attributes
  | Psig_class l -> line i ppf "Psig_class\n"; list i class_description ppf l
  | Psig_class_type l ->
    line i ppf "Psig_class_type\n"; list i class_type_declaration ppf l
  | Psig_extension ((s, arg), attrs) ->
    line i ppf "Psig_extension \"%s\"\n" s.txt;
    attributes i ppf attrs; payload i ppf arg
...
and module_expr i ppf x =
  ...
  | Pmod_structure s -> line i ppf "Pmod_structure\n"; structure i ppf s
  ...
  | Pmod_extension (s, arg) ->
    line i ppf "Pmod_extension \"%s\"\n" s.txt; payload i ppf arg
  | Pmod_hole -> line i ppf "Pmod_hole"
...
and structure_item i ppf x =
  ...
  | Pstr_exception te -> line i ppf "Pstr_exception\n"; type_exception i ppf te
  ...
  | Pstr_open od ->
    ...
    module_expr i ppf od.popen_expr; attributes i ppf od.popen_attributes
  | Pstr_class l -> line i ppf "Pstr_class\n"; list i class_declaration ppf l
  | Pstr_class_type l ->
    line i ppf "Pstr_class_type\n"; list i class_type_declaration ppf l
  | Pstr_include incl ->
    line i ppf "Pstr_include";
    attributes i ppf incl.pincl_attributes; module_expr i ppf incl.pincl_mod
...
and module_declaration i ppf pmd =
  ...
  attributes i ppf pmd.pmd_attributes; module_type (i + 1) ppf pmd.pmd_type

and module_binding i ppf x =
  str_opt_loc i ppf x.pmb_name;
  attributes i ppf x.pmb_attributes; module_expr (i + 1) ppf x.pmb_expr
...
=
  ...
  line (i + 1) ppf "%a" fmt_string_loc pld_name; core_type (i + 1) ppf pld_type

and longident_x_pattern i ppf (li, p) =
  line i ppf "%a\n" fmt_longident_loc li; pattern (i + 1) ppf p
...
and value_binding i ppf x =
  ...
  pattern (i + 1) ppf x.pvb_pat; expression (i + 1) ppf x.pvb_expr

and binding_op i ppf x =
  line i ppf "<binding_op> %a %a" fmt_string_loc x.pbop_op fmt_location
    x.pbop_loc;
  pattern (i + 1) ppf x.pbop_pat; expression (i + 1) ppf x.pbop_exp

and string_x_expression i ppf (s, e) =
  line i ppf "<override> %a\n" fmt_string_loc s; expression (i + 1) ppf e

and longident_x_expression i ppf (li, e) =
  line i ppf "%a\n" fmt_longident_loc li; expression (i + 1) ppf e

and label_x_expression i ppf (l, e) =
  line i ppf "<arg>\n"; arg_label i ppf l; expression (i + 1) ppf e

and label_x_bool_x_core_type_list i ppf x =
  match x.prf_desc with
  | Rtag (l, b, ctl) ->
    line i ppf "Rtag \"%s\" %s\n" l.txt (string_of_bool b);
    attributes (i + 1) ppf x.prf_attributes; list (i + 1) core_type ppf ctl
  | Rinherit ct -> line i ppf "Rinherit\n"; core_type (i + 1) ppf ct

let rec toplevel_phrase i ppf x =
  match x with
  | Ptop_def s -> line i ppf "Ptop_def\n"; structure (i + 1) ppf s
