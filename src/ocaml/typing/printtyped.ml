...
let fmt_modname f = function None -> fprintf f "_" | Some id -> Ident.print f id
...
let fmt_virtual_flag f x =
  match x with Virtual -> fprintf f "Virtual" | Concrete -> fprintf f "Concrete"
...
let fmt_rec_flag f x =
  match x with Nonrecursive -> fprintf f "Nonrec" | Recursive -> fprintf f "Rec"
...
let line i f s (*...*) = fprintf f "%s" (String.make (2 * i) ' '); fprintf f s
(*...*)
...
let rec core_type i ppf x =
  ...
  | Ttyp_arrow (l, ct1, ct2) ->
    ...
    arg_label i ppf l; core_type i ppf ct1; core_type i ppf ct2
  | Ttyp_tuple l -> line i ppf "Ttyp_tuple\n"; list i core_type ppf l
  | Ttyp_constr (li, _, l) ->
    line i ppf "Ttyp_constr %a\n" fmt_path li; list i core_type ppf l
  ...
  | Ttyp_object (l, c) ->
    ...
    List.iter (fun { of_desc; of_attributes; _ } ->
      ...
      | OTtag (s, t) ->
        line i ppf "method %s\n" s.txt;
        attributes i ppf of_attributes; core_type (i + 1) ppf t
      | OTinherit ct -> line i ppf "OTinherit\n"; core_type (i + 1) ppf ct
    ) l
  | Ttyp_class (li, _, l) ->
    line i ppf "Ttyp_class %a\n" fmt_path li; list i core_type ppf l
  | Ttyp_alias (ct, s) -> line i ppf "Ttyp_alias \"%s\"\n" s; core_type i ppf ct
  | Ttyp_poly (sl, ct) ->
    line i ppf "Ttyp_poly%a\n" (fun ppf ->
      List.iter (fun x -> fprintf ppf " '%s" x)
    ) sl;
    core_type i ppf ct
  | Ttyp_package { pack_path = s; pack_fields = l } ->
    line i ppf "Ttyp_package %a\n" fmt_path s; list i package_with ppf l

and package_with i ppf (s, t) =
  line i ppf "with type %a\n" fmt_longident s; core_type i ppf t
...
and pattern_extra i ppf (extra_pat, _, attrs) =
  ...
  | Tpat_unpack -> line i ppf "Tpat_extra_unpack\n"; attributes i ppf attrs
  | Tpat_constraint cty ->
    line i ppf "Tpat_extra_constraint\n";
    attributes i ppf attrs; core_type i ppf cty
  | Tpat_type (id, _) ->
    line i ppf "Tpat_extra_type %a\n" fmt_path id; attributes i ppf attrs
  | Tpat_open (id, _, _) ->
...
and expression_extra i ppf x attrs =
  match x with
  | Texp_constraint ct ->
    line i ppf "Texp_constraint\n"; attributes i ppf attrs; core_type i ppf ct
  | Texp_coerce (cto1, cto2) ->
    line i ppf "Texp_coerce\n";
    attributes i ppf attrs; option i core_type ppf cto1; core_type i ppf cto2
  | Texp_poly cto ->
    line i ppf "Texp_poly\n"; attributes i ppf attrs; option i core_type ppf cto
  | Texp_newtype s ->
    line i ppf "Texp_newtype \"%s\"\n" s; attributes i ppf attrs
...
and expression i ppf x =
  ...
  | Texp_let (rf, l, e) ->
    ...
    list i value_binding ppf l; expression i ppf e
  | Texp_function { arg_label = p; param = _; cases; partial = _ } ->
    line i ppf "Texp_function\n"; arg_label i ppf p; list i case ppf cases
  | Texp_apply (e, l) ->
    line i ppf "Texp_apply\n";
    expression i ppf e; list i label_x_expression ppf l
  ...
  | Texp_construct (li, _, eo) ->
    line i ppf "Texp_construct %a\n" fmt_longident li; list i expression ppf eo
  | Texp_variant (l, eo) ->
    line i ppf "Texp_variant \"%s\"\n" l; option i expression ppf eo
  ...
  | Texp_setfield (e1, li, _, e2) ->
    ...
    expression i ppf e1; longident i ppf li; expression i ppf e2
  | Texp_array l -> line i ppf "Texp_array\n"; list i expression ppf l
  | Texp_ifthenelse (e1, e2, eo) ->
    line i ppf "Texp_ifthenelse\n";
    expression i ppf e1; expression i ppf e2; option i expression ppf eo
  | Texp_sequence (e1, e2) ->
  ...
  | Texp_letop { let_; ands; param = _; body; partial = _ } ->
    ...
    list (i + 1) binding_op ppf ands; case i ppf body
  ...
  | Texp_open (o, e) ->
    ...
    attributes i ppf o.open_attributes; expression i ppf e
  | Texp_hole -> line i ppf "Texp_hole"

and value_description i ppf x =
  line i ppf "value_description %a %a\n" fmt_ident x.val_id fmt_location
    x.val_loc;
  attributes i ppf x.val_attributes;
  core_type (i + 1) ppf x.val_desc; list (i + 1) string ppf x.val_prim
...
and type_kind i ppf x =
  ...
  | Ttype_record l -> line i ppf "Ttype_record\n"; list (i + 1) label_decl ppf l
...
and extension_constructor_kind i ppf x =
  ...
  | Text_decl (a, r) ->
    ...
    constructor_arguments (i + 1) ppf a; option (i + 1) core_type ppf r
  | Text_rebind (p, _) ->
...
and class_type i ppf x =
  ...
  | Tcty_signature cs -> line i ppf "Tcty_signature\n"; class_signature i ppf cs
  | Tcty_arrow (l, co, cl) ->
    line i ppf "Tcty_arrow\n";
    arg_label i ppf l; core_type i ppf co; class_type i ppf cl
  | Tcty_open (o, e) ->
...
and class_signature i ppf { csig_self = ct; csig_fields = l } =
  ...
  core_type (i + 1) ppf ct; list (i + 1) class_type_field ppf l
...
and class_type_field i ppf x =
  ...
  | Tctf_inherit ct -> line i ppf "Tctf_inherit\n"; class_type i ppf ct
  | Tctf_val (s, mf, vf, ct) ->
  ...
  | Tctf_constraint (ct1, ct2) ->
    ...
    core_type (i + 1) ppf ct1; core_type (i + 1) ppf ct2
...
and class_expr i ppf x =
  ...
  | Tcl_structure cs -> line i ppf "Tcl_structure\n"; class_structure i ppf cs
  | Tcl_fun (l, p, _, ce, _) ->
    line i ppf "Tcl_fun\n";
    arg_label i ppf l; pattern i ppf p; class_expr i ppf ce
  | Tcl_apply (ce, l) ->
    line i ppf "Tcl_apply\n";
    class_expr i ppf ce; list i label_x_expression ppf l
  | Tcl_let (rf, l1, l2, ce) ->
    line i ppf "Tcl_let %a\n" fmt_rec_flag rf;
    list i value_binding ppf l1;
    list i ident_x_expression_def ppf l2; class_expr i ppf ce
  | Tcl_constraint (ce, Some ct, _, _, _) ->
    line i ppf "Tcl_constraint\n"; class_expr i ppf ce; class_type i ppf ct
...
and class_structure i ppf { cstr_self = p; cstr_fields = l } =
  ...
  pattern (i + 1) ppf p; list (i + 1) class_field ppf l
...
and class_field i ppf x =
  ...
  | Tcf_inherit (ovf, ce, so, _, _) ->
    ...
    class_expr (i + 1) ppf ce; option (i + 1) string ppf so
  | Tcf_val (s, mf, _, k, _) ->
...
and class_field_kind i ppf =
  function
  | Tcfk_concrete (o, e) ->
    line i ppf "Concrete %a\n" fmt_override_flag o; expression i ppf e
...
and module_type i ppf x =
  ...
  | Tmty_signature s -> line i ppf "Tmty_signature\n"; signature i ppf s
  | Tmty_functor (Unit, mt2) ->
    line i ppf "Tmty_functor ()\n"; module_type i ppf mt2
  | Tmty_functor (Named (s, _, mt1), mt2) ->
    line i ppf "Tmty_functor \"%a\"\n" fmt_modname s;
    module_type i ppf mt1; module_type i ppf mt2
  | Tmty_with (mt, l) ->
    line i ppf "Tmty_with\n";
    module_type i ppf mt; list i longident_x_with_constraint ppf l
  | Tmty_typeof m -> line i ppf "Tmty_typeof\n"; module_expr i ppf m
...
and signature_item i ppf x =
  ...
  | Tsig_value vd -> line i ppf "Tsig_value\n"; value_description i ppf vd
  | Tsig_type (rf, l) ->
    line i ppf "Tsig_type %a\n" fmt_rec_flag rf; list i type_declaration ppf l
  | Tsig_typesubst l ->
    line i ppf "Tsig_typesubst\n"; list i type_declaration ppf l
  | Tsig_typext e -> line i ppf "Tsig_typext\n"; type_extension i ppf e
  | Tsig_exception ext ->
    line i ppf "Tsig_exception\n"; type_exception i ppf ext
  | Tsig_module md ->
    line i ppf "Tsig_module \"%a\"\n" fmt_modname md.md_id;
    attributes i ppf md.md_attributes; module_type i ppf md.md_type
  | Tsig_modsubst ms ->
  ...
  | Tsig_modtype x ->
    ...
    attributes i ppf x.mtd_attributes; modtype_declaration i ppf x.mtd_type
  | Tsig_open od ->
  ...
  | Tsig_include incl ->
    ...
    attributes i ppf incl.incl_attributes; module_type i ppf incl.incl_mod
  | Tsig_class l -> line i ppf "Tsig_class\n"; list i class_description ppf l
  | Tsig_class_type l ->
...
and module_declaration i ppf md =
  ...
  attributes i ppf md.md_attributes; module_type (i + 1) ppf md.md_type

and module_binding i ppf x =
  line i ppf "%a\n" fmt_modname x.mb_id;
  attributes i ppf x.mb_attributes; module_expr (i + 1) ppf x.mb_expr
...
and structure_item i ppf x =
  ...
  | Tstr_open od ->
    ...
    module_expr i ppf od.open_expr; attributes i ppf od.open_attributes
  | Tstr_class l ->
  ...
  | Tstr_include incl ->
    ...
    attributes i ppf incl.incl_attributes; module_expr i ppf incl.incl_mod
  | Tstr_attribute a -> attribute i ppf "Tstr_attribute" a

and longident_x_with_constraint i ppf (li, _, wc) =
  line i ppf "%a\n" fmt_path li; with_constraint (i + 1) ppf wc
...
and constructor_decl
    i ppf { cd_id; cd_name = _; cd_args; cd_res; cd_loc; cd_attributes }
=
  line i ppf "%a\n" fmt_location cd_loc;
  line (i + 1) ppf "%a\n" fmt_ident cd_id;
  attributes i ppf cd_attributes;
  constructor_arguments (i + 1) ppf cd_args; option (i + 1) core_type ppf cd_res
...
=
  ...
  line (i + 1) ppf "%a" fmt_ident ld_id; core_type (i + 1) ppf ld_type

and longident_x_pattern i ppf (li, _, p) =
  line i ppf "%a\n" fmt_longident li; pattern (i + 1) ppf p
...
and value_binding i ppf x =
  ...
  pattern (i + 1) ppf x.vb_pat; expression (i + 1) ppf x.vb_expr

and string_x_expression i ppf (s, _, e) =
  line i ppf "<override> \"%a\"\n" fmt_path s; expression (i + 1) ppf e

and record_field i ppf =
  function
  | _, Overridden (li, e) ->
    line i ppf "%a\n" fmt_longident li; expression (i + 1) ppf e
...
and ident_x_expression_def i ppf (l, e) =
  line i ppf "<def> \"%a\"\n" fmt_ident l; expression (i + 1) ppf e

and label_x_bool_x_core_type_list i ppf x =
  match x.rf_desc with
  | Ttag (l, b, ctl) ->
    line i ppf "Ttag \"%s\" %s\n" l.txt (string_of_bool b);
    attributes (i + 1) ppf x.rf_attributes; list (i + 1) core_type ppf ctl
  | Tinherit ct -> line i ppf "Tinherit\n"; core_type (i + 1) ppf ct
