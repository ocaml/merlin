...
(* The incremental API. *)
  ...
  type _ terminal =
    ...
    | T_QUOTED_STRING_ITEM
        : (string * Location.t * string * Location.t * string option) terminal
  ...
  type _ nonterminal =
    ...
    | N_value_description
        : (Parsetree.value_description * string Location.loc option) nonterminal
    | N_value
        :
        ((string Location.loc
    ...
    | N_type_kind
        ...
        nonterminal
    | N_type_constraint
        : (Parsetree.core_type option * Parsetree.core_type option) nonterminal
    ...
    | N_str_exception_declaration
        : (Parsetree.type_exception * string Location.loc option) nonterminal
    ...
    | N_reversed_preceded_or_separated_nonempty_llist_BAR_match_case_
        : Parsetree.case list nonterminal
    ...
    | N_reversed_nonempty_llist_labeled_simple_expr_
        : (Asttypes.arg_label * Parsetree.expression) list nonterminal
    | N_reversed_nonempty_llist_functor_arg_
        : (Lexing.position * Parsetree.functor_parameter) list nonterminal
    ...
    | N_reversed_bar_llist_extension_constructor_declaration_
        : Parsetree.extension_constructor list nonterminal
    | N_reversed_bar_llist_extension_constructor_
        : Parsetree.extension_constructor list nonterminal
    | N_reversed_bar_llist_constructor_declaration_
        : Parsetree.constructor_declaration list nonterminal
    ...
    | N_private_virtual_flags
        : (Asttypes.private_flag * Asttypes.virtual_flag) nonterminal
    ...
    | N_option_type_constraint_
        :
        (Parsetree.core_type option * Parsetree.core_type option) option
        nonterminal
    | N_option_preceded_EQUAL_seq_expr__
        : Parsetree.expression option nonterminal
    | N_option_preceded_EQUAL_pattern__ : Parsetree.pattern option nonterminal
    | N_option_preceded_EQUAL_module_type__
        : Parsetree.module_type option nonterminal
    | N_option_preceded_EQUAL_expr__ : Parsetree.expression option nonterminal
    | N_option_preceded_COLON_core_type__
        : Parsetree.core_type option nonterminal
    | N_option_preceded_AS_mkrhs_LIDENT___
    ...
    | N_open_description
        : (Parsetree.open_description * string Location.loc option) nonterminal
    | N_open_declaration
        : (Parsetree.open_declaration * string Location.loc option) nonterminal
    | N_nonempty_type_kind
        :
        (Parsetree.type_kind
         * Asttypes.private_flag
         * Parsetree.core_type option)
    ...
    | N_mutable_virtual_flags
        : (Asttypes.mutable_flag * Asttypes.virtual_flag) nonterminal
    ...
    | N_module_subst
        :
        (Parsetree.module_substitution * string Location.loc option) nonterminal
    ...
    | N_method_
        ...
        nonterminal
    | N_meth_list
        : (Parsetree.object_field list * Asttypes.closed_flag) nonterminal
    ...
    | N_list_text_str_structure_item__
        : Parsetree.structure_item list list nonterminal
    | N_list_text_cstr_class_field__
        : Parsetree.class_field list list nonterminal
    | N_list_text_csig_class_sig_field__
        : Parsetree.class_type_field list list nonterminal
    ...
    | N_list_generic_and_type_declaration_type_subst_kind__
        : Parsetree.type_declaration list nonterminal
    ...
    | N_list_and_module_declaration_
        : Parsetree.module_declaration list nonterminal
    | N_list_and_module_binding_ : Parsetree.module_binding list nonterminal
    | N_list_and_class_type_declaration_
        : Parsetree.class_type_declaration list nonterminal
    | N_list_and_class_description_
        : Parsetree.class_description list nonterminal
    | N_list_and_class_declaration_
        : Parsetree.class_declaration list nonterminal
    | N_letop_bindings
        :
        (Parsetree.pattern * Parsetree.expression * Parsetree.binding_op list)
        nonterminal
    | N_letop_binding_body
        : (Parsetree.pattern * Parsetree.expression) nonterminal
    ...
    | N_labeled_simple_expr
        : (Asttypes.arg_label * Parsetree.expression) nonterminal
    ...
    | N_functor_args
        : (Lexing.position * Parsetree.functor_parameter) list nonterminal
    | N_functor_arg
        : (Lexing.position * Parsetree.functor_parameter) nonterminal
    ...
    | N_constrain_field
        : (Parsetree.core_type * Parsetree.core_type) nonterminal
  ...
  include
  MenhirLib.IncrementalEngine.INSPECTION with type 'a lr1state := 'a lr1state
