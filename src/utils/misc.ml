...
external fs_exact_case_basename : string -> string option
    ...
    begin
      ...
      List.find_map path ~f:(fun dirname ->
          if exact_file_exists ~dirname ~basename:uname then
            ...
            let () =
              Logger.log ~section:"locate" ~title:"find_in_path_uncap"
...
module String = struct
  include CamlString
  module Ord = struct type t = string let compare = String.compare end
