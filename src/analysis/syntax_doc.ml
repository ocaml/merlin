...
type info = { name : string; description : string; documentation : string }
...
let get_syntax_doc node =
  let info =
        ...
        Some
          {
            ...
            description =
              "Local substitutions behave like destructive substitutions \
               `(with ... := ...)` but instead of being applied to a whole \
               signature after the fact, they are introduced during the \
        ...
        Some
          {
            ...
            description =
              "Module type substitution essentially behaves like type \
               substitutions. They are useful to refine an abstract module \
        ...
        Some
          {
            name = "Variant Types";
            description =
              "Lets you represent data that may take on multiple different \
               forms.";
            documentation =
        ...
        Some
          {
            ...
            description =
              "Values of a record type declared private can be de-structured \
               via the expr . field notation. However, values of these types \
               cannot be constructed directly by record construction.";
            documentation =
              "https://v2.ocaml.org/releases/5.1/htmlman/privatetypes.html#ss:private-types-variant";
          }
    | (_, Type_kind Ttype_open)
        ...
        Some
          {
            ...
            description =
              "A private type abbreviation declares a type that is distinct \
               from its implementation type `typexpr`.";
            documentation =
        ...
        Some
          {
            ...
            description =
              "The `let rec` binding construct, in addition to the definition \
               of recursive functions, also supports a certain class of \
               recursive definitions of non-functional values, such as `let \
               rec name1 = 1 :: name2 and name2 = 2 :: name1 in expr` which \
               binds `name1` to the cyclic list `1::2::1::2::…`, and `name2` \
               to the cyclic list `2::1::2::1::…`";
            documentation =
              "https://v2.ocaml.org/releases/5.1/htmlman/letrecvalues.html";
          }
    | [ (_, Structure _) ] ->
        Some
          {
    ...
    | (_, Module_expr _)
      :: (_, Module_type { mty_desc = Tmty_typeof _; _ })
      :: _ ->
        Some
          {
            ...
            documentation =
              "https://v2.ocaml.org/releases/5.1/htmlman/moduletypeof.html";
          }
    | node -> (
            ...
            Some
              {
                ...
                description =
                  "Recursive module definitions, introduced by the `module rec \
                   …and …` construction, generalize regular module definitions \
                   `module module-name = module-expr` and module \
                   specifications `module module-name : module-type` by \
                   allowing the defining `module-expr` and the `module-type` \
                   to refer recursively to the module identifiers being \
                   defined.";
                documentation =
            ...
            Some
              {
                ...
                description =
                  "The expression `fun ( type typeconstr-name ) -> expr` \
                   introduces a type constructor named `typeconstr-name` which \
                   is considered abstract in the scope of the sub-expression, \
                   ...
                   vb_expr =
                     {
                       ...
                       exp_extra =
                         [
                           ( Texp_constraint { ctyp_desc = Ttyp_package _; _ },
                             _,
                             _ );
                         ];
                       _;
            ...
            Some
              {
                ...
                description =
                  "The expression ( `module module-expr : package-type` ) \
                   converts the module (structure or functor) denoted by \
                   module expression `module-expr` to a value of the core \
                   language that encapsulates this module.";
                documentation =
