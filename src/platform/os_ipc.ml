...
external server_setup
  : string -> string -> server option = "ml_merlin_server_setup"

external server_accept
  : server -> timeout:float -> client option = "ml_merlin_server_accept"
...
external context_close
  : context -> return_code:int -> unit = "ml_merlin_context_close"
...
external merlin_dont_inherit_stdio
  : bool -> unit = "ml_merlin_dont_inherit_stdio"
